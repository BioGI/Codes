  ...
  SUBROUTINE XYSpatialInterpolateBufferToFineGrid    ! Interpolate required variables on the two buffer rows to fine grid
    ...
    do k=1, gridRatio+1, gridRatio
       do j=2,nySub_fine-1
          ...
          dsCtoF_backYZ(2,3,j,k) = spatialInterpolate(f1,f2,f3,f4,node(57,lCyIndex-1,lCzIndex),node(57,lCyIndex,lCzIndex),node(57,lCyIndex+1,lCzIndex),node(57,lCyIndex+2,lCzIndex),yInterp) !Interpolate the latest value to the last(third) time step
          ...
          velCtoF_backYZ(1,3,j,k) = spatialInterpolate(f1,f2,f3,f4,node(57,lCyIndex-1,lCzIndex),node(57,lCyIndex,lCzIndex),node(57,lCyIndex+1,lCzIndex),node(57,lCyIndex+2,lCzIndex),yInterp) !Interpolate the latest value to the last(third) time step
          f1 =  v(57,lCyIndex-1,lCzIndex) 
          f2 =  v(57,lCyIndex,lCzIndex) 
          f3 =  v(57,lCyIndex+1,lCzIndex) 
          f4 =  v(57,lCyIndex+2,lCzIndex) 
          velCtoF_backYZ(2,3,j,k) = spatialInterpolate(f1,f2,f3,f4,node(57,lCyIndex-1,lCzIndex),node(57,lCyIndex,lCzIndex),node(57,lCyIndex+1,lCzIndex),node(57,lCyIndex+2,lCzIndex),yInterp) !Interpolate the latest value to the last(third) time step
          f1 =  w(57,lCyIndex-1,lCzIndex) 
          f2 =  w(57,lCyIndex,lCzIndex) 
          f3 =  w(57,lCyIndex+1,lCzIndex) 
          f4 =  w(57,lCyIndex+2,lCzIndex) 
          velCtoF_backYZ(3,3,j,k) = spatialInterpolate(f1,f2,f3,f4,node(57,lCyIndex-1,lCzIndex),node(57,lCyIndex,lCzIndex),node(57,lCyIndex+1,lCzIndex),node(57,lCyIndex+2,lCzIndex),yInterp) !Interpolate the latest value to the last(third) time step
          ...
          f3 =  phi(57,lCyIndex+1,lCzIndex) 
          f4 =  phi(57,lCyIndex+2,lCzIndex) 
          dsCtoF_backYZ(2,3,j,nzSub_fine-gridRatio+1-k+1) = spatialInterpolate(f1,f2,f3,f4,node(57,lCyIndex-1,lCzIndex),node(57,lCyIndex,lCzIndex),node(57,lCyIndex+1,lCzIndex),node(57,lCyIndex+2,lCzIndex),yInterp) !Interpolate the latest value to the last(third) time step
          ...
          f3 =  u(57,lCyIndex+1,lCzIndex) 
          f4 =  u(57,lCyIndex+2,lCzIndex) 
          velCtoF_backYZ(1,3,j,nzSub_fine-gridRatio+1-k+1) = spatialInterpolate(f1,f2,f3,f4,node(57,lCyIndex-1,lCzIndex),node(57,lCyIndex,lCzIndex),node(57,lCyIndex+1,lCzIndex),node(57,lCyIndex+2,lCzIndex),yInterp) !Interpolate the latest value to the last(third) time step
          f1 =  v(57,lCyIndex-1,lCzIndex) 
          f2 =  v(57,lCyIndex,lCzIndex) 
          f3 =  v(57,lCyIndex+1,lCzIndex) 
          f4 =  v(57,lCyIndex+2,lCzIndex) 
          velCtoF_backYZ(2,3,j,nzSub_fine-gridRatio+1-k+1) = spatialInterpolate(f1,f2,f3,f4,node(57,lCyIndex-1,lCzIndex),node(57,lCyIndex,lCzIndex),node(57,lCyIndex+1,lCzIndex),node(57,lCyIndex+2,lCzIndex),yInterp) !Interpolate the latest value to the last(third) time step
          f1 =  w(57,lCyIndex-1,lCzIndex) 
          f2 =  w(57,lCyIndex,lCzIndex) 
          f3 =  w(57,lCyIndex+1,lCzIndex) 
          f4 =  w(57,lCyIndex+2,lCzIndex) 
          velCtoF_backYZ(3,3,j,nzSub_fine-gridRatio+1-k+1) = spatialInterpolate(f1,f2,f3,f4,node(57,lCyIndex-1,lCzIndex),node(57,lCyIndex,lCzIndex),node(57,lCyIndex+1,lCzIndex),node(57,lCyIndex+2,lCzIndex),yInterp) !Interpolate the latest value to the last(third) time step
...
!    write(31,*) 'iter = ', iter
    ...
    do k=1,nzSub_fine
       do i=1,nxSub_fine
          do m=0,NumDistDirs
             f_fine(m,i,1,k) = fPlus(m,lowerCoarseXIndex(i),lowerCoarseYIndex(1), closestCoarseZIndex(z_fine(k))) !temporalInterpolate(fCtoF_bottomXZ(m,1,i,k),fCtoF_bottomXZ(m,2,i,k),fCtoF_bottomXZ(m,3,i,k), node_fine_bottomXZ(1,i,k), node_fine_bottomXZ(2,i,k), node_fine_bottomXZ(3,i,k), tInterp)
             f_fine(m,i,ny_fine,k) = fPlus(m,lowerCoarseXIndex(i),lowerCoarseYIndex(ny_fine), closestCoarseZIndex(z_fine(k))) !temporalInterpolate(fCtoF_topXZ(m,1,i,k),fCtoF_topXZ(m,2,i,k),fCtoF_topXZ(m,3,i,k), node_fine_topXZ(1,i,k), node_fine_topXZ(2,i,k), node_fine_topXZ(3,i,k), tInterp)
          end do
          rho_fine(i,1,k) = 1.0 !temporalInterpolate(dsCtoF_bottomXZ(1,1,i,k),dsCtoF_bottomXZ(1,2,i,k),dsCtoF_bottomXZ(1,3,i,k),node_fine_bottomXZ(1,i,k), node_fine_bottomXZ(2,i,k), node_fine_bottomXZ(3,i,k), tInterp)
          phi_fine(i,1,k) = phiTemp(lowerCoarseXIndex(i),lowerCoarseYIndex(1), closestCoarseZIndex(z_fine(k))) !temporalInterpolate(dsCtoF_bottomXZ(2,1,i,k),dsCtoF_bottomXZ(2,2,i,k),dsCtoF_bottomXZ(2,3,i,k), node_fine_bottomXZ(1,i,k), node_fine_bottomXZ(2,i,k), node_fine_bottomXZ(3,i,k), tInterp)

!          if ( ( mod((i-1),gridRatio) .eq. 0) .and. (mod((k-1),gridRatio) .eq. 0)) then
!             tmp = phiTemp(lowerCoarseXIndex(i),lowerCoarseYIndex(1), closestCoarseZIndex(z_fine(k))) - dsCtoF_bottomXZ(2,2,i,k)
!             if (abs(tmp)/dsCtoF_bottomXZ(2,2,i,k) .gt. 1e-10) then
!                write(31,*) 'Coarse mesh indices = ', lowerCoarseXIndex(i),lowerCoarseYIndex(1), closestCoarseZIndex(z_fine(k))
!                write(31,*) 'Fine mesh indices = ', i,1,k
!                write(31,*) 'Fine Coarse phi = ', phi_fine(i,1,k),  dsCtoF_bottomXZ(2,2,i,k), phiTemp(lowerCoarseXIndex(i),lowerCoarseYIndex(1), closestCoarseZIndex(z_fine(k)))
                !             write(31,*) '3 time coarse = ', dsCtoF_bottomXZ(2,1,i,k),dsCtoF_bottomXZ(2,2,i,k),dsCtoF_bottomXZ(2,3,i,k)
!             end if
!          end if
          u_fine(i,1,k) = 0.0 !temporalInterpolate(velCtoF_bottomXZ(1,1,i,k),velCtoF_bottomXZ(1,2,i,k),velCtoF_bottomXZ(1,3,i,k), node_fine_bottomXZ(1,i,k), node_fine_bottomXZ(2,i,k), node_fine_bottomXZ(3,i,k), tInterp)
          v_fine(i,1,k) = 0.0 !temporalInterpolate(velCtoF_bottomXZ(2,1,i,k),velCtoF_bottomXZ(2,2,i,k),velCtoF_bottomXZ(2,3,i,k), node_fine_bottomXZ(1,i,k), node_fine_bottomXZ(2,i,k), node_fine_bottomXZ(3,i,k), tInterp)
          w_fine(i,1,k) = 0.0 !temporalInterpolate(velCtoF_bottomXZ(3,1,i,k),velCtoF_bottomXZ(3,2,i,k),velCtoF_bottomXZ(3,3,i,k), node_fine_bottomXZ(1,i,k), node_fine_bottomXZ(2,i,k), node_fine_bottomXZ(3,i,k), tInterp)          
...
!          if ( (mod((i-1),gridRatio) .eq. 0) .and. (mod((k-1),gridRatio) .eq. 0)) then
    ...
    do k=1,nzSub_fine
       do j=2,nySub_fine-1
          do m=0,NumDistDirs
             f_fine(m,1,j,k) = fPlus(m,lowerCoarseXIndex(1),lowerCoarseYIndex(j), closestCoarseZIndex(z_fine(k))) !temporalInterpolate(fCtoF_frontYZ(m,1,j,k),fCtoF_frontYZ(m,2,j,k),fCtoF_frontYZ(m,3,j,k), node_fine_frontYZ(1,j,k), node_fine_frontYZ(2,j,k), node_fine_frontYZ(3,j,k), tInterp)
             f_fine(m,nx_fine,j,k) = fPlus(m,lowerCoarseXIndex(nx_fine),lowerCoarseYIndex(j), closestCoarseZIndex(z_fine(k))) !temporalInterpolate(fCtoF_backYZ(m,1,j,k),fCtoF_backYZ(m,2,j,k),fCtoF_backYZ(m,3,j,k), node_fine_backYZ(1,j,k), node_fine_backYZ(2,j,k), node_fine_backYZ(3,j,k), tInterp)
          end do
...
!          end if
          ...
          w_fine(1,j,k) = 0.0 !temporalInterpolate(velCtoF_frontYZ(3,1,j,k),velCtoF_frontYZ(3,2,j,k),velCtoF_frontYZ(3,3,j,k), node_fine_frontYZ(1,j,k), node_fine_frontYZ(2,j,k), node_fine_frontYZ(3,j,k), tInterp)
...
!          end if
          ...
          w_fine(nx_fine,j,k) = 0.0 !temporalInterpolate(velCtoF_backYZ(3,1,j,k),velCtoF_backYZ(3,2,j,k),velCtoF_backYZ(3,3,j,k), node_fine_backYZ(1,j,k), node_fine_backYZ(2,j,k), node_fine_backYZ(3,j,k), tInterp)        
