...
allocate(fCtoF_topXZ(0:NumDistDirs,3,nxSub_fine,-gridRatio+1:nzSub_fine+gridRatio+1))     !Includes the ends - Indices are directionalDensity, timeLevel, x Index, z Index
allocate(fCtoF_bottomXZ(0:NumDistDirs,3,nxSub_fine,-gridRatio+1:nzSub_fine+gridRatio+1))  !Includes the ends - Indices are directionalDensity, timeLevel, x Index, z Index
allocate(fCtoF_frontYZ(0:NumDistDirs,3,2:nySub_fine-1,-gridRatio+1:nzSub_fine+gridRatio+1))   !Does not include the ends - Indices are directionalDensity, timeLevel, y Index, z Index
allocate(fCtoF_backYZ(0:NumDistDirs,3,2:nySub_fine-1,-gridRatio+1:nzSub_fine+gridRatio+1))    !Does not include the ends - Indices are directionalDensity, timeLevel, y Index, z Index
...
allocate(node_fine_frontYZ(3,2:nySub_fine-1,-gridRatio+1:nzSub_fine+gridRatio+1))   !Does not include the ends - Indices are directionalDensity, timeLevel, y Index, z Index
